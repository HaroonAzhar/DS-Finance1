...
### Dataset Overview
The credit card fraud dataset contains 284,807 transactions with 31 features including anonymized PCA components (V1–V28), Time, Amount, and the target variable Class.

### Data Cleaning
- Checked for missing values (none found).
- Inspected duplicate records and removed them if present.
- Verified data types for consistency.

### Class Imbalance
Fraud transactions represent approximately 0.17% of total transactions, indicating severe class imbalance. This influenced our modeling and evaluation strategy.

### Exploratory Analysis
- Visualized class distribution.
- Analyzed transaction amount distribution.
- Compared fraud vs non-fraud patterns.
- Generated correlation heatmap to examine feature relationships.
...
Authors: 
Raghavendra Uppilisrinivasan, Purushottam Kumar, Haroon Azhar Khan, Baruni Prabaharan , Jyoti Shukla
